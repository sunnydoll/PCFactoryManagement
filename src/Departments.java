...
//		  return "<tr><td>" + did + "</td><td>" + name + "</td><td>" + budget + "</td></tr>";
		return "<tr><td>" + name + "</td><td>" + budget + "</td><td><a href='/~zc77/servlet/ServDeptView?id=" + did + "'>View</a> <a href='/~zc77/servlet/ServDeptMod?id=" + did + "'>Modify</a> <a href='/~zc77/servlet/ServDeptDel?id=" + did + "'>Delete</a></td></tr>";
	}
