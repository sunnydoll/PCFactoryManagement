...
public class Products {
	...
	public String toHTML() {
		return "<tr><td>" + pid + "</td><td>" + name + "</td><td>" + stock + "</td><td><a href='/~zc77/servlet/ServProdView?id=" + pid + "'>View</a> <a href='/~zc77/servlet/ServProdMod?id=" + pid + "'>Modify</a> <a href='/~zc77/servlet/ServProdDel?id=" + pid + "'>Delete</a></td></tr>";
	}
}
